...
const swaggerOptions = {
    definition: {
        ...
        info: {
          title: 'RepP API',
          description: 'Metodos para comunicação entre os sistemas e o Rep-P do PontovixMTE 2.0, bem como realização de marcação de ponto',
          version: '1.0.0',
        },
        components: {
          securitySchemes: {
    ...
    if(!value){
      bcrypt.genSalt(12).then( (value) =>{
          passwordHash = bcrypt.hash('guedes', value).then( (value) => {
              Empresa.create({cnpj:'09267210000115',contrato:'00000',login:'guedes',senha:value,razao:'Inforvix Comercial LTDA ME',fantasia:'Inforvix',email:'henrique@inforvix.com.br',ativo:true})
    })})}})
})
